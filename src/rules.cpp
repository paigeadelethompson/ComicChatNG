...
EmotionId analyzeId(const QString &text)
{
    ...
    if (t.contains(QLatin1String("angry")) || t.contains(QLatin1String("hate"))
        || t.contains(QLatin1String("grr")) || t.contains(QLatin1String("damn")))
    ...
    if (t.contains(QLatin1String("scare")) || t.contains(QLatin1String("afraid"))
        || t.contains(QLatin1String("eek")) || t.contains(QLatin1String("help")))
        return EmotionId::Scared;

    if (t.contains(QLatin1String("bored")) || t.contains(QLatin1String("meh"))
        || t.contains(QLatin1String("whatever")))
        return EmotionId::Bored;

    if (t.contains(QLatin1String("love")) || t.contains(QLatin1String("cute"))
        || t.contains(QLatin1String(":)")) || t.contains(QLatin1String(":-)"))
