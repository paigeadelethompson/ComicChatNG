...
Emotion emotionFromId(EmotionId id, float intensity) {
  switch (id) {
  case EmotionId::Happy:
    return {intensity, emHappy()};
  case EmotionId::Coy:
    return {intensity, emCoy()};
  case EmotionId::Bored:
    return {intensity, emBored()};
  case EmotionId::Scared:
    return {intensity, emScared()};
  case EmotionId::Sad:
    return {intensity, emSad()};
  case EmotionId::Angry:
    return {intensity, emAngry()};
  case EmotionId::Shout:
    return {intensity, emShout()};
  case EmotionId::Laugh:
    return {intensity, emLaugh()};
