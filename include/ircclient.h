...
signals:
    ...
    void userParted(const QString &channel, const QString &nick, const QString &reason);
    ...
    void privmsg(const QString &channel, const QString &nick, const QString &text);
...
private:
    ...
    void handleNumeric(int code, const QString &prefix, const QStringList &args, const QString &trailing);
    void handlePrivmsg(const QString &nick, const QString &target, const QString &text);
